...
export const CartButtonAdd: FC<CartButtonAddProps> = ({
  cartId,
  productId,
  type,
  disable,
  ...
  return (
    <button
      onClick={() => {
        dispatch(updateCart({ cartId, productId, quantity: 1 }));
      }}
